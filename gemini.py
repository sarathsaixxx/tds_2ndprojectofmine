...
When returning the final JSON result, **do not include keys**, return **only a JSON array of values**, matching the order of the questions asked or results generated.
...
6. When returning the final JSON result, **do not include keys**, return **only a JSON array of values**, matching the order of the questions asked or results generated.
